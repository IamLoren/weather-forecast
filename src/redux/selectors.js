...
export const today = state => state.todayInSelectedCity;
export const startDateInSelectedCity = state => state.startDateInSelectedCity;
export const modalOpen = state => state.isModalOpen;